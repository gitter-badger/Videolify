...
var recStartTime;
var recElapsedTime;
var videolifyTheme = "neon"; // neon - dark - forest - ghost ...
...
/**
 * Set videolify theme neon - dark - ghost
 * @param {*} theme
 */
function setTheme(theme) {
  ...
  switch (videolifyTheme) {
    case "neon":
      ...
      document.documentElement.style.setProperty(
        "--box-shadow",
        "3px 3px 6px #00eeff, -3px -3px 6px #00ff2a"
      );
      document.documentElement.style.setProperty(
        "--box-bg",
        "blue"
    ...
    case "dark":
      ...
      document.documentElement.style.setProperty(
        "--box-shadow",
        "3px 3px 6px #0a0b0c, -3px -3px 6px #575f8a"
      );
      break;
    case "forest":
      // forest theme
      ...
      document.documentElement.style.setProperty(
        "--box-shadow",
        "3px 3px 6px #27944f, -3px -3px 6px #00ff37"
      );
      break;
    case "sky":
      // sky theme
      ...
      document.documentElement.style.setProperty(
        "--box-shadow",
        "3px 3px 6px #0c95b7, -3px -3px 6px #012a5f"
      );
      break;
    case "ghost":
      // ghost theme
 ...
 */
function setEraser() {
  videolifyTheme == "dark" ? (color = "#000000") : (color = "#ffffff");
  drawsize = 10;
  whiteboardColorPicker.value = color;
}
...
function selectFileToShare() {
  ...
  Swal.fire({
    allowOutsideClick: false,
    background: swalBackground,
    imageAlt: "videolify-file-sharing",
  ...
  if (isImageURL(incomingFileInfo.fileName)) {
    ...
    reader.onload = (e) => {
      Swal.fire({
        ...
        imageAlt: "videolify-file-img-download",
        showDenyButton: true,
    ...
    Swal.fire({
      allowOutsideClick: false,
      background: swalBackground,
      imageAlt: "videolify-file-download",
      imageUrl: fileSharingImg,
      position: "center",
      title: "Received file",
      text:
...
function disableAllPeers(element) {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    imageAlt: "videolify-disable-" + element,
    imageUrl: confirmImg,
    title:
      element == "audio"
        ? "Mute everyone except yourself?"
...
function getAbout() {
  ...
  Swal.fire({
    ...
    imageAlt: "videolify-about",
    imageUrl: aboutImg,
    html: `
    <br/>
    <div id="about"><b>open source</b> project on<a href="https://github.com/Jaideep25/Videolify" target="_blank"><h1><strong> GitHub </strong></h1></a></div>
    <div id="author"><a target="_blank">Authors: Jaideep25 & Miroslav Pejic</a></div><br>
    `,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
